...
"firstLayerSize", "secondLayerSize", "outputNeuron", and "class_list" are to be set the same parameters in the notebook that generated the model, makeModelMNIST.ipynb or makeModelCIFAR10.ipynb.

...
"models" directory has sample models generated by makeModelMNIST.ipynb.
"makeSimplex.ipynb" can work without other notebooks by setting the "model_name" parameter in it.
